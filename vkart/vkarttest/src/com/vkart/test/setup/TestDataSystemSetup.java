...
import com.vkart.test.constants.VkartTestConstants;
import com.vkart.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = VkartTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/vkarttest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/vkarttest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/vkarttest/import/cstickets.impex");
			...
			importImpexFile(context, "/vkarttest/import/csquotes.impex");
		}
	}
}
