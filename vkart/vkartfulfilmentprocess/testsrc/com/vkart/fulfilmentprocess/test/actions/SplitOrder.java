 ...
 */
package com.vkart.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(VkartFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(VkartFulfilmentProcessConstants.PARENT_PROCESS);
