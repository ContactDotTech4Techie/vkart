...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/vkartstorefront/electronics/en",
						"https://electronics.local:9002/vkartstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/vkartstorefront/electronics/en",
						"https://electronics.local:9002/vkartstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/vkartstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/vkartstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/vkartstorefront/electronics/en",
						"https://electronics.local:9002/vkartstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/vkartstorefront",
						"https://electronics.local:9002/vkartstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/vkartstorefront",
						"https://electronics.local:9002/vkartstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/vkartstorefront/electronics/en",
						"https://electronics.local:9002/vkartstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
